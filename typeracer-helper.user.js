...
var observer = new MutationObserver(function(mutations) {
  if (mutations[0].addedNodes.length) {
    if (
      ...
      mutations[0].addedNodes[0].className
        .split(" ")
        .indexOf("countdownPopup") != -1
    ) {
      var target = document.querySelector(
        "table > tbody > tr:nth-child(2) > td > table.inputPanel"
      );
      target.onkeydown = function(e) {
        if (e.keyCode == SPACEBAR) {
          setTimeout(function() {
            var textBody = document.querySelector(
              "table > tbody > tr:nth-child(2) > td > table.inputPanel > tbody > tr:nth-child(1) > td > table > tbody"
            );
            ...
            if (
              textBodyClone.querySelectorAll(
                "tr:nth-child(1) > td > div > div > span"
              ).length > 3
            ) {
              // Typed words
              textBodyClone.querySelector(
                "tr:nth-child(1) > td > div > div > span:first-child"
              ).className += " typedWords";

              // First charactor of current word
              textBodyClone.querySelector(
                "tr:nth-child(1) > td > div > div > span:nth-last-child(3)"
            ...
            textBodyClone.querySelector(
              "tr:nth-child(1) > td > div > div > span:nth-last-child(2)"
            ).style.backgroundColor = mask;
            textBodyClone.querySelector(
              "tr:nth-child(1) > td > div > div > span:nth-last-child(2)"
            ).style.color = mask;
            ...
            var t = textBodyClone.querySelector(
              "tr:nth-child(1) > td > div > div > span:last-child"
            );
            ...
            var existingTextMasks = document.querySelectorAll(
              "table > tbody > tr:nth-child(2) > td > table.inputPanel > tbody > tr:nth-child(1) > td > table > tbody.TRHelperTextMask"
            );
            ...
            if (existingTextMasks && existingTextMasks.length > maxTextMasks) {
              for (
                let i = 0;
                i < existingTextMasks.length - maxTextMasks;
                i++
              ) {
